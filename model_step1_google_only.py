...
def build_design_matrix(
    ...
    # Light imputation (should be rare if data is ready-to-use)
    # Use linear interpolation then ffill/bfill as a safe fallback.
    ...
    # Build X with intercept + Google + month dummies
    feature_cols = ["intercept", "g_fever", "g_vaccine"] + list(month_dummies.columns)
    df["intercept"] = 1.0
